...
Q_IMPORT_QML_PLUGIN(LiveMessageApplicationContentPlugin)
Q_IMPORT_QML_PLUGIN(LiveMessageApplicationPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/LiveMessageApplicationContent/App.qml";
